...
for III in range(6):
    try:
        ...
        _nearest, _label2id = assign_to_nearest(_samples, centroids,label2id)
        ...
        f = open('../output/1hide-new/result_hide_new.txt','a')
        ...
        _savename='../output/1hide-new/confusion_hide_new{}.png'.format(III)
